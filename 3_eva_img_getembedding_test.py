...
train_df = pd.read_csv('test/done_geo_category_none_test_processed_na_time.csv')
...
class regnety_008(nn.Module):
    def __init__(self, n_classes, pretrained=True):
        super(regnety_008, self).__init__()

        self.model = timm.create_model("regnety_008", pretrained=True)
        self.model.head.fc = nn.Linear(self.model.head.fc.in_features, 100)
        # self.logit = nn.Linear(100, 1)
...
df_100.to_csv('train/eva_embeddinig_test_25.csv')
print('done')