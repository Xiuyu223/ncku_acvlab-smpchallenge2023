...
df_100.to_csv('/ssd8/ming/flickr/new_old_train_combine/geo_alias/BLIP_embeddinig_train_alltag_img_text.csv')
import pickle

df_100.to_pickle('/ssd8/ming/multi_lang_emb/new_pickle/train/LARGE_newtrain_BLIP_embeddinig_train_alltag_img_text.pkl')
print('done')