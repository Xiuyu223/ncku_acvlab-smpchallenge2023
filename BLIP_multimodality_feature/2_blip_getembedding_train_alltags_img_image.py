...
train_df = pd.read_csv(
    "../train/done_geo_category_none_old_train_processed_na_time.csv",
    encoding='utf-8')
...
df_100.to_csv('/ssd8/ming/flickr/new_old_train_combine/geo_alias/BLIP_embeddinig_train_alltag_img_image.csv')
import pickle

df_100.to_pickle('/ssd8/ming/multi_lang_emb/new_pickle/train/LARGE_newtrain_BLIP_embeddinig_train_alltag_img_image.pkl')
print('done')