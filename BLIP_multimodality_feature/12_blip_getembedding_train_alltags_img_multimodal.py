...
train_df = pd.read_csv(
    "/ssd8/ming/flickr/new_old_train_combine/geo_alias/done_geo_category_none_old_train_processed_na_time.csv",
    encoding='utf-8')
train_df['Alltags'] = train_df['Alltags'].fillna('NONE')
train_df = train_df.dropna(subset=['img_filepath_local'])
batch_size = 1
train_df.loc[train_df['Alltags'].str.len() > 300, 'Alltags'] = 'NONE'
#train_df.loc[9023, 'Alltags']='NONE'
...
df_100.to_csv('/ssd8/ming/flickr/new_old_train_combine/geo_alias/BLIP_embeddinig_train_alltag_img_multimodal.csv')
import pickle

df_100.to_pickle('/ssd8/ming/multi_lang_emb/new_pickle/train/LARGE_newtrain_BLIP_embeddinig_train_alltag_img_multimodal.pkl')
print('done')