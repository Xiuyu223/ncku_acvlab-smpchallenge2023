...
train_df = pd.read_csv(
    "../train/done_geo_category_none_test_processed_na_time.csv",
    encoding='utf-8')

train_df.loc[82357, 'Alltags']='NONE'

train_df['img_filepath_local'] = train_df['img_filepath_local'].str.rstrip('\n')

train_df['Alltags'] = train_df['Alltags'].fillna('NONE')
train_df['img_filepath_local'] = train_df['img_filepath_local'].fillna('NONE')
...
def get_embeddings(model, dataloader, device):
    ...
    with torch.no_grad():
        ...
        for step, data in bar:
            ...
            outputs = model(images, data_text, mode='multimodal')[0, 0]
...
df_100.to_csv('/ssd8/ming/flickr/new_old_train_combine/geo_alias/BLIP_embeddinig_test_alltag_img_multimodal.csv')
import pickle

df_100.to_pickle('/ssd8/ming/multi_lang_emb/new_pickle/test/LARGE_newtrain_BLIP_embeddinig_test_alltag_img_multimodal.pkl')
print('done')